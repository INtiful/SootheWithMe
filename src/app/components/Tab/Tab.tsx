...
const Tab = ({ type, isActive, onClick }: TabProps) => {
  const styles = isActive
    ? 'text-var-gray-900 first-of-type:before:right-0 last-of-type:before:left-0 dark:text-neutral-50'
    : 'text-var-gray-400 first-of-type:before:-right-full last-of-type:before:-left-full dark:text-neutral-500';
